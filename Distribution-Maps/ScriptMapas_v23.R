...
### Script v23  (R. Riina 30 Jan 2023)
...
####  con datos de GBIF [Me bajé los datos de GBIF - "preserved specimend" ###
###   archivo "terracina_gbif.csv"
##############################################################################
...
### Ahora vamos a obtener los datos de la especie de interés del archivo 
### "terracina_gbif.csv" previamente descargado del portal GBIF 
### y almacenarlos en la tabla o dataframe que llamaremos 'myspecies'

myspecies <-  read.table("terracina_gbif.csv", sep="\t",fill=TRUE,header=TRUE,quote="")
...
### “decimalLatitude”, “decimalLongitude”, y “countryCode” 

localidades <- subset(myspecies, select=c("countryCode", "decimalLatitude", "decimalLongitude"))
...
### indicamos qué columnas ("decimalLongitude", "decimalLatitude") corresponden 
### a la longitud y latitud de nuestros puntos
...
### Observa el mapa obtenido (se puede exportar como png o pdf) y trata de 
### indentificar posibles errores. 
...
table(locs$countryCode)

locs.spain <- subset(locs, locs$countryCode == "ES")  
...
addnortharrow(pos="bottomright", scale=0.4, padin = c(0.1,0.5)) 
